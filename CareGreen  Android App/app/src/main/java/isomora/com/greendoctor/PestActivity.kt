...
class PestActivity : AppCompatActivity() {
    ...
    private fun createItems() {
        ...
        addItem("Grapes", arrayOf("Black Rot", "Esca Black Measles", "Blight Isariopsis Leaf Spot", "Healthy"), R.color.g1, R.drawable.grape)
    ...
    private fun configureSubItem(item: ExpandingItem?, view: View, subTitle: String, title: String) {
        ...
        view.findViewById<ImageView>(R.id.sub_item)
            .setOnClickListener(View.OnClickListener {

                val detailIntent = Intent(this, DetailActivity::class.java)
                detailIntent.putExtra("leaf", title)
                detailIntent.putExtra("disease", subTitle )
                detailIntent.putExtra("key", 2)
